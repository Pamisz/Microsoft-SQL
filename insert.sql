INSERT INTO Języki_obce(Nazwa_języka_obcego) VALUES
('Angielski'),
('Niemiecki'),
('Francuski'),
('Hiszpański'),
...
INSERT INTO Producent (Nazwa_producenta, Kraj_pochodzenia, Rok_założenia, Siedziba_główna) VALUES
...
INSERT INTO Osoba (Pesel, Imię, Nazwisko, Adres_email, Numer_kontaktowy, Data_urodzenia) VALUES
...
('95030334567', 'Marta', 'Wiśniewska', 'marta.wisniewska@example.com', '555-345-678', '1995-03-03'),
...
('96060667890', 'Paweł', 'Nowicki', 'pawel.nowicki@example.com', '555-678-901', '1996-06-06'),
('87070778901', 'Katarzyna', 'Piotrowska', 'katarzyna.piotrowska@example.com', '555-789-012', '1987-07-07'),
('93080889012', 'Adam', 'Zieliński', 'adam.zielinski@example.com', '555-890-123', '1993-08-08'),
...
('80010112345', 'Robert', 'Szymański', 'robert.szymanski@example.com', '555-123-456', '1980-01-01'),
...
('89040445678', 'Agnieszka', 'Dąbrowska', 'agnieszka.dabrowska@example.com', '555-456-789', '1989-04-04'),
...
('93090990123', 'Kamil', 'Kamiński', 'kamil.kaminski@example.com', '555-901-234', '1993-09-09'),
...
('90040434567', 'Daniel', 'Kozłowski', 'daniel.kozlowski@example.com', '555-345-678', '1990-01-13'),
('95050545678', 'Oliwia', 'Jabłońska', 'oliwia.jablonska@example.com', '555-456-789', '1995-02-14'),
('89060656789', 'Rafał', 'Leszczyński', 'rafal.leszczynski@example.com', '555-567-890', '1989-03-15'),
...
('89011101234', 'Nina', 'Zielińska', 'nina.zielinska@example.com', '555-012-345', '1989-08-20'),

('92031323456', 'Julia', 'Lewandowska', 'julia.lewandowska@example.com', '555-234-567', '1992-10-22'),
('90041434567', 'Michał', 'Szymczak', 'michal.szymczak@example.com', '555-345-678', '1990-11-23'),
('95051545678', 'Alicja', 'Ostrowska', 'alicja.ostrowska@example.com', '555-456-789', '1995-12-24'),
('89061656789', 'Łukasz', 'Baran', 'lukasz.baran@example.com', '555-567-890', '1989-01-25'),
...
('86101089012', 'Nikola', 'Błaszczyk', 'nikola.blaszczyk@example.com', '555-890-123', '1986-04-28'),
('93111190123', 'Igor', 'Głowacki', 'igor.glowacki@example.com', '555-901-234', '1993-05-29'),
...
INSERT INTO Sprzedawca (ID,Stanowisko, Data_zatrudnienia, Liczba_transakcji, Wartość_transakcji, Języki_obce) VALUES
(1,'Doradca ds. Sprzedaży', '2022-01-01', 2, 182000.11, 1),
(2,'Specjalista ds. Samochodów Sportowych', '2021-02-15', 1, 93000.50, 2),
(3,'Młodszy doradca ds. Sprzedaży', '2020-03-10', 0, 0.00, 3),
(4,'Młodszy doradca ds. Sprzedaży', '2022-04-05', 0, 0.00, 6),
(5,'Starszy Doradca ds. Finansowania', '2019-05-20', 1, 72000.44, 9),
(6,'Kierownik Działu Sprzedaży', '2020-06-15', 2, 159000.84, 4),
(7,'Doradca ds. Leasingu', '2021-07-01', 2, 190000.84, 5),
(8,'Młodszy doradca ds. Sprzedaży', '2018-08-25', 0, 0.00, 7),
(9,'Specjalista ds. Leasingu Operacyjnego', '2019-09-10', 2, 111000.57, 8),
(10,'Doradca ds. Sprzedaży', '2021-11-20', 1, 34000.76, 10),

(11,'Doradca ds. Klientów VIP', '2019-12-15', 2, 66000.85, 2),
(12,'Doradca ds. Sprzedaży', '2022-01-10', 1, 42000.71, 1),
(13,'Doradca ds. Sprzedaży', '2021-03-20', 1, 65000.04, 2),
(14,'Młodszy doradca ds. Sprzedaży', '2018-04-05', 0, 0.00, 1),
(15,'Specjalista ds. Samochodów Luksusowych', '2019-05-20', 2, 93000.38, 2),
(16,'Doradca ds. Pojazdów Dostawczych', '2020-06-15', 1, 108000.65, 1),
(17,'Młodszy doradca ds. Sprzedaży', '2021-07-01', 0, 0.00, 1),
(18,'Doradca ds. Sprzedaży', '2018-08-25', 1, 40000.01, 2),
(19,'Młodszy doradca ds. Sprzedaży', '2022-02-15', 0, 00.00, 1),
(20,'Starszy Doradca ds. Finansowania', '2021-03-01', 1, 48000.01, 1)
;

INSERT INTO Klient (ID,Historia_transakcji, Data_ostatniego_zakupu, Wydana_kwota, Status_Gwarancji, Preferowana_marka) VALUES
(21,'Zakup samochodu sportowego w 2022', '2022-01-10', 82000.01, 1, 'Toyota'),
(22,'Zakup samochodu rodzinengo w 2022', '2022-03-15', 93000.50, 1, 'Volkswagen'),
(23,'Zakup samochodu terenoweg w 2021', '2021-05-20', 100000.10, 0, 'Lexus'),
(24,'Zakup samochodu dostawczego w 2020', '2020-07-25', 48000.01, 0, 'Honda'),
(25,'Zakup samochodu sportowego w 2019', '2019-09-30', 72000.44, 0, 'BMW'),
(26,'Zakup samochodu sportowego w 2023', '2023-11-05', 82000.14, 1, 'Toyota'),
(27,'Zakup samochodu rodzinengo w 2013', '2013-01-10', 98000.74, 0, 'Toyota'),
(28,'Zakup samochodu terenoweg w 2009', '2009-03-15', 42000.71, 0, 'Volkswagen'),
(29,'Zakup samochodu dostawczego w 2011', '2011-05-20', 50000.14, 0, 'Audi'),
(30,'Zakup samochodu sportowego w 2023', '2023-07-25', 34000.76, 1, 'Lexus'),

(31,'Zakup samochodu sportowego w 2023', '2023-09-30', 38000.43, 1, 'Mercedes-Benz'),
(32,'Zakup samochodu terenoweg w 2021', '2021-11-05', 77000.70, 0, 'Toyota'),
(33,'Zakup samochodu dostawczego w 2012', '2012-01-10', 65000.04, 0, 'Nissan'),
(34,'Zakup samochodu sportowego w 2008', '2008-03-15', 92000.10, 0, 'Toyota'),
(35,'Zakup samochodu rodzinengo w 2022', '2022-05-20', 54000.34, 1, 'Ford'),
(36,'Zakup samochodu sportowego w 2015', '2015-07-25', 108000.65, 0, 'Land Rover'),
(37,'Zakup samochodu terenoweg w 2014', '2014-09-30', 61000.43, 0, 'Chevrolet'),
(38,'Zakup samochodu sportowego w 2020', '2020-11-05', 40000.01, 0, 'Volkswagen'),
(39,'Zakup samochodu dostawczego w 2019', '2019-01-10', 39000.04, 0, 'Honda'),
(40,'Zakup samochodu sportowego w 2013', '2013-03-15', 28000.42, 0, 'BMW')
;

INSERT INTO Dostawca (Nazwa_dostawcy, Adres_dostawcy, Numer_kontaktowy_dostawcy, Adres_email_dostawcy) VALUES
('Toyota Dealership', 'ul. Dealerska 123, 01-234 Gdańsk', '123-456-789', 'toyota_dealer@email.com'),
...
('Tesla Automotive', 'ul. Elektryczna 456, 45-678 Poznań', '444-555-666', 'tesla_auto@email.com'),
('Mercedes-Benz Dealership', 'ul. Benz 789, 56-789 Toruń', '777-888-999', 'mercedes_dealer@email.com'),
('Audi Autohaus', 'ul. Autohaus 123, 67-890 Warszawa', '123-987-654', 'audi_autohaus@email.com'),
('Land Rover Showroom', 'ul. Land Rover 123, 89-012 Wrocaław', '555-111-222', 'landrover_showroom@email.com'),
('Nissan Exclusive', 'ul. Nissan 456, 90-123 Poznań', '333-444-555', 'nissan_exclusive@email.com'),
...
('Nissan Auto Center', 'ul. Nissan 456, 67-890 Wałbrzych', '333-444-555', 'nissan_autocenter@email.com'),
('Subaru Showroom', 'ul. Subaru 789, 78-901 Wrocław', '999-111-222', 'subaru_showroom@email.com'),
...
INSERT INTO Model (Nazwa_modelu, Generacja, Typ_nadwozia, Skrzynia_biegów, Dostępność, ID_producenta) VALUES
...
('Arteon', 'I', 5, 'Półautomatyczna', 1, 2)
;

INSERT INTO Wersja (Nazwa_wersji, Silnik, Wyposażenie, Opcje_dodatkowe, ID_modelu) VALUES
('Standard', '2.0 TDI', 'Klimatyzacja, Radio', 'Ogrzewane fotele, Navigacja', 1),
('Comfortline', '1.6 TDI', 'Klimatyzacja automatyczna, Radio z Bluetooth', 'Ogrzewane fotele, Pakiet bezpieczeństwa', 2),
('Luxury', '3.0 Diesel', 'Klimatyzacja dwustrefowa, Skórzane fotele', 'Nawigacja, Dach panoramiczny', 3),
('Tekna', '1.5 dCi', 'Klimatyzacja automatyczna, System multimedialny', 'Kamera cofania, System bezpieczeństwa', 4),
...
('5FNRL384X2B111111', 2019, 'Benzyna', 'Biały', 60000, 5),
...
('WBAPH77589A234567', 2012, 'Benzyna', 'Biały', 100000, 10),
...
('5FNRL384X2B333333', 2015, 'Benzyna', 'Biały', 55000, 17),
...
INSERT INTO Oferta (Data_rozpoczęcia, Data_zakończenia, Kwota_oferty, Okres_gwarancji, Status_oferty, VIN) VALUES
...
INSERT INTO Jazda_testowa (Data_jazdy_testowej, Godzina_rozpoczęcia, Godzina_zakończenia, VIN, Klient, Sprzedawca) VALUES
...
INSERT INTO Sprzedaż (Kwota_transakcji, Data_transakcji, VIN, Klient, Sprzedawca) VALUES
